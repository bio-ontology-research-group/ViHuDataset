...
@ck.command()
@ck.option('--kge_model', '-kge', default="TransE", type=str)
...
@ck.option('--epochs', '-ep', default=100, type=int)
...
def main(kge_model, embedding_dimension, learning_rate, batch_size,
    ...
    wandb_logger = wandb.init(entity='ferzcam', project='hpi_analysis', group='owl2vec_kge', name=wandb_description)
