def print_as_md(overall_metrics):
    ...
    metrics = ["test_mr", "test_mrr", "test_hits@10", "test_hits@100", "test_auc"]
    filt_metrics = [k.replace("_", "_f_") for k in metrics]

    string_metrics = "| Property | MR | MRR | Hits@10 | Hits@100 | AUC |  \n"
    string_metrics += "| --- | --- | --- | --- | --- | --- | --- | --- | --- | \n"
    string_filtered_metrics = "| Property | MR | MRR | Hits@10 | Hits@100 | AUC | \n"
